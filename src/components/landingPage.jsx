...
export default function LandingPage() {
  ...
  return (
    <div className='bg-black'>
      <div style={{ backgroundImage: `url(${bgImage})` }} className="bg-cover bg-center pb-30 pt-10 w-full">
          ...
          <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-3xl text-center">
              ...
              <div class="group relative mt-10 inline-flex">
                <a href="#" title="" class="rounded-xl bg-primary px-10 py-3 font-medium text-black transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 hover:bg-blue-600">
                  Upload Document</a>
                <div class="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-white md:inline-flex">
      ...
      <img
        src={test}
        className='relative shadow-[-1px_-150px_1000px_-50px_#2b6cb0] mx-auto mt-40 rounded-3xl border-gray-100 before:absolute before:top-0 before:left-0 before:w-full before:h-full before:rounded-3xl before:bg-gradient-to-b before:from-transparent before:to-black before:z-10'
      />
