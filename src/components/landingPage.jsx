...
export default function LandingPage() {
  ...
  return (
    <div className='bg-black max-h-full'>
      <div style={{ backgroundImage: `url(${bgImage})` }} className="bg-cover bg-center pb-30 pt-8 w-full">
          ...
          <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-3xl text-center">
              ...
              <div className='flex justify-center mt-4 font-sans'>
                <p className='text-gray-400 text-center text-sm px-3 py-1 outline outline-gray-600 outline-1 bg-slate-900 rounded-xl border-solid mx-1 z-50'>PDF</p>
                <p className='text-gray-400 text-center text-sm px-3 py-1 outline outline-gray-600 outline-1 bg-slate-900 rounded-xl mx-1 z-50'>DOC</p>
                <p className='text-gray-400 text-center text-sm px-3 py-1 outline outline-gray-600 outline-1 bg-slate-900 rounded-xl mx-1 z-50'>TXT</p>
              </div>
            </div>
          </div>
